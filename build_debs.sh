...
Section: education
Priority: optional
Depends: python3, python3-venv, python3-tk, python3-pil, python3-pil.imagetk, python3-socketio, python3-engineio, python3-websocket, python3-requests, python3-pynput, python3-numpy, xdotool, ydotool, kde-spectacle | grim | gnome-screenshot, python3-gi, python3-dbus, python3-gst-1.0, gstreamer1.0-pipewire, gstreamer1.0-plugins-base, gir1.2-gstreamer-1.0, python3-evdev, python3-aiortc, python3-av, debconf
